...
public class ProfileTab extends Fragment {
    ...
    private EditText edtProfileName, edtProfileBio, edtProfileProfession, edtProfileHobbies, edtProfileFavouriteSport;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtProfileFavouriteSport = view.findViewById(R.id.edtProfileFavouriteSport);
        ...
        edtProfileFavouriteSport.setText(parseUser.get("profileFavouriteSport")+"");
        ...
        btnUpdateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                parseUser.put("profileFavouriteSport", edtProfileFavouriteSport.getText().toString());
